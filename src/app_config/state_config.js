...
// admin -----------------------------------------------------------------------    
    ...
    var adminCataloguesState = {
        name: 'main.admin.catalogues',
        url: '/catalogues',
        cached:false,
        templateUrl: 'app_parts/main/admin/catalogues/catalogues.html',
        controller: 'adminCataloguesCtrl'
    };
    var adminQuestionState = {
        name: 'main.admin.questions',
        url: '/questions',
        cached:false,
        templateUrl: 'app_parts/main/admin/questions/questions.html',
    ...
    var adminSquareTypes = {
        ...
        url: '/squaretypes',
        cached:false,
        templateUrl: 'app_parts/main/admin/squaretypes/squaretypes.html',
        controller: 'adminSquareTypesCtrl'
    };
// database --------------------------------------------------------------------
    var databaseState = {
        name: 'main.database',
...
//-------------------------------------------------------------------------------
    ...
    $stateProvider.state(adminCataloguesState);
    $stateProvider.state(adminQuestionState);
